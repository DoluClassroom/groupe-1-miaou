...
object Config {
  ...
  val nexusHttpUrl = "http://dev.davidsoergel.com/nexus"
  //val nexusHttpsUrl = "https://dev.davidsoergel.com/nexus"

  val DavidSoergelReleaseRepos = Seq(
    "David Soergel Public Releases" at  nexusHttpUrl + "/content/groups/public",
    "David Soergel Private Releases" at nexusHttpUrl + "/content/repositories/private-releases")

  val DavidSoergelSnapshotRepos = Seq(
    "David Soergel Public Snapshots" at nexusHttpUrl + "/content/groups/public-snapshots",
    "David Soergel Private Snapshots" at  nexusHttpUrl + "content/repositories/private-snapshots")
